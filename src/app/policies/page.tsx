  ...
  return (
    <div className="container max-w-3xl mx-auto py-16 md:py-24">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight">our policies</h1>
        <p className="mt-2 text-muted-foreground">clear intentions, just like our tees.</p>
      </div>
      ...
      <Tabs defaultValue="shipping" className="w-full">
        ...
        <TabsContent value="shipping" className="mt-6 p-6 bg-card rounded-lg">
        ...
        <TabsContent value="returns" className="mt-6 p-6 bg-card rounded-lg">
        ...
        <TabsContent value="privacy" className="mt-6 p-6 bg-card rounded-lg">
